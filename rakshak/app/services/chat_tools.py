...
async def _get_inventory_logic(domain: str, db: AsyncSession) -> str:
...
async def _get_cbom_logic(hostname: str, db: AsyncSession) -> str:
...
async def _get_remediation_logic(hostname: str, db: AsyncSession) -> str:
    result = await db.execute(
