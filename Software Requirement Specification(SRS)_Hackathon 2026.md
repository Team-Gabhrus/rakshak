...
## Problem Statement
To develop a software scanner to validate deployment of Quantum proof cipher and create cryptographic bill of material (CBOM) inventory for public facing applications (Web Server, API, System).
...
* Assets that successfully implement NIST-standardized Post-Quantum Algorithms are automatically awarded a digital "Post Quantum Cryptography (PQC) Ready" or "Fully Quantum Safe" certificate/label. This provides immediate assurance to users that the system is shielded against future cryptanalytic threats.

---
*"Quantum-Ready Cybersecurity for Future-Safe Banking"*

**PNB Cybersecurity Hackathon 2025-26** *(Page 1 of 1)*